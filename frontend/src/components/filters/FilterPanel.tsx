...
export default function FilterPanel({ children, activeCount, defaultOpen = true, onClear }: FilterPanelProps) {
  ...
  return (
    <div className="mb-4 rounded-lg border border-gray-200 bg-gray-50">
      <div className="flex items-center">
        <button
          onClick={() => setOpen((v) => !v)}
          className="flex flex-1 items-center justify-between px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-lg transition-colors"
        >
